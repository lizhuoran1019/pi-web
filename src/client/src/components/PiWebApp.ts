...
export class PiWebApp extends LitElement {
  ...
  private readonly handleRewriteMessage = (entryId: string, text: string): Promise<void> => this.sessions.rewriteMessage(entryId, text);
